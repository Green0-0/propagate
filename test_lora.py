...
try:
    ...
    backend = VLLMBackendLoRA(model_name="Qwen/Qwen2.5-3B-Instruct", NUM_GPUS=1, CPUS_PER_GPU=12, GPU_FRACTION_VLLM_WORKER=0.85, Sampler=sampler, population_size=12, lora_rank=16, max_loras=12, use_tqdm=True, time_self=True)
