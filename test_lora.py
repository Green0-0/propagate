...
try:
    ...
    backend = VLLMBackendLoRA(model_name="Qwen/Qwen2.5-3B-Instruct", NUM_GPUS=4, CPUS_PER_GPU=6, GPU_FRACTION_VLLM_WORKER=0.7, Sampler=sampler, population_size=28, lora_rank=16, use_tqdm=False, time_self=True)
    
    optimizer = SimpleOptimizer(total_steps=150, learning_rate=0.0005, seed_weight=0.001)
