...
try:
    ...
    optimizer = Optimizer(optimizer_name="Test Optimizer", total_steps=200, learning_rate=25, perturb_scale=0.001, mirror=True, population_size=14, perturb_chain=perturb_chain, update_chain=update_chain, norm_by_mean=False, rank_norm_rewards=False)
