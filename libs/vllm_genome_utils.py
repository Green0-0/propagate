...
class WorkerExtension:
    ...
    def perturb_self_weights(self, genome: Genome):
        genome.update_tensor(named_parameters=self.model_runner.model.named_parameters())
    ...
    def restore_self_weights(self, genome: Genome):
        genome.restore_tensor(named_parameters=self.model_runner.model.named_parameters())
